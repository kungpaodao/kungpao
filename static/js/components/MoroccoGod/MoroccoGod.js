        ...
        <div>
            ...
            <section className={active ? 'top-cards-div pt-4 ml-5' : 'top-cards-div pt-4'}>
                <div className="container">
                    <p className='pts text-color'>KungPao Token (PAO) CONTRACT ADDRESS : 0x2A11149C59FCbdCDcA4680ed19f25C12AA9427D8</p>
                                ...
                                <button className='w-100 box'>
                                    <div className="innerCards">
                                        <div className='newheader'>
                                            <h4><img src="/box-icon.svg"></img> PAO</h4>
                                        </div>
                                        {/* <hr /> */}
                                        <p className='mt-1 text-center'>My Balance {history / 10**18}  PAO</p>
                                       <input type="text" className='form-control' placeholder='Enter amount to stake'  onChange={(e) => setprojectDescription(e.target.value)} ></input>
                                       <button className='btn btn-stake' onClick={stake}>Stake</button>
                                    </div>
                                </button>
                            </a>
                        </div>
                            ...
                            <a >
                                <button className='w-100'>
                                    <div className="innerCards ">
                                        ...
                                        {/* <hr /> */}
                                        <p className='mt-1 text-center'>My Balance {history /10**18} PAO</p>
                                        <input type="text" className='form-control' placeholder='Enter amount to withdraw'  onChange={(e) => setproject(e.target.value)}></input>
                                       <button className='btn btn-stake' onClick={unstake}>Withdraw Reward</button>
                                    </div>
                                </button>
                            </a>
                        </div>
